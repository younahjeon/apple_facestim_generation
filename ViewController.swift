...
class ViewController: UIViewController, ARSessionDelegate {
    ...
    func getFrameData() -> CaptureData? { // Organize arkit's data
        ...
        guard let shaderURL = Bundle.main.url(forResource: "shader", withExtension: "shader"),
        ...
        let camTransform = arFrame.camera.transform
        let imageResolution_width = arFrame.camera.imageResolution.width
        let imageResolution_height = arFrame.camera.imageResolution.height
        let projTransform = arFrame.camera.projectionMatrix
        let faceTransform = anchor.transform
        
        let data = CaptureData(vertices: vertices, camTransform: arFrame.camera.transform, faceTransform: anchor.transform, projTransform: projTransform,imageResolution_width: arFrame.camera.imageResolution.width, imageResolution_height: arFrame.camera.imageResolution.height, blendShapes: anchor.blendShapes)
        return data
    }
